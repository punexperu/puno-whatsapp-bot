...
// Suscribirse a presencia para forzar sesion Signal y routing LID
try { await sock.presenceSubscribe(jid); } catch(_) {}
// Esperar respuesta de presencia (puede poblar lidToJid)
if (jid.endsWith('@lid')) await new Promise(r => setTimeout(r, 1500));
const resolvedJid = resolveJid(jid);
console.log('RESOLVED: ' + resolvedJid + ' | map=' + Object.keys(lidToJid).length);
